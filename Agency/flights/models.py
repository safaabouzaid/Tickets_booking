...
class SeatType(models.Model):
    ...
    economy=models.IntegerField( null=True, blank=False, unique=True)
    business_class=models.IntegerField( null=True, blank=False, unique=True)
    first_class=models.IntegerField( null=True, blank=False, unique=True)
